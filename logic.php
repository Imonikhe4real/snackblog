		...
		if($stmt->rowCount()>0)
		{
			while($row=$stmt->fetch(PDO::FETCH_ASSOC))
			{
				...
				?>
     	 		...
     	 		<br><br><br>
     	 	 <a href="registration.php" class="btn btn-info" style="font-weight:bolder;">Read More...</a>   	 	
                  <br><br>
                <?php
			}
		}
...
public function delete($id){
    ...
    $sql = "DELETE FROM sanckstb WHERE id = :id";
    $stmt = $this->conn->prepare($sql);
    $stmt->bindParam(':id',$id);
    $stmt->execute();
    if ($stmt) {
...
public function insertuser(){
  ...
  $sql = "INSERT INTO comments(title,name,comment)VALUES(:title,:name,:comment)";
    ...
    echo "<br>";
    echo "<center><b>User Comment Added Successfully</b></center>";
    echo "<br>";
    echo "<br>";
